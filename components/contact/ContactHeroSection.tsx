...
const ContactHeroSection: React.FC = () => {
  ...
  const imageUrl = "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?q=80&w=2070&auto=format&fit=crop";
      ...
      <div className="relative z-10 p-6 md:p-8 max-w-4xl mx-auto">
        ...
        >
          <p className="mt-6 text-lg md:text-xl max-w-2xl mx-auto text-gray-300 leading-relaxed">
            Reach out for bookings, inquiries, or special requests.
          </p>
        </div>
      </div>
    </section>
